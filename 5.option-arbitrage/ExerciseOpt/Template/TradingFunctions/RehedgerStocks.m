...
%         end
        ...
        %myCallDeltaChangeAsk = (aBot.StockDepth.askLimitPrice(1)-aBot.ownTrades.price(end))*0.3193;
        %myCallDeltaChangeBid = (aBot.StockDepth.bidLimitPrice(1)-aBot.ownTrades.price(end))*0.3193;
